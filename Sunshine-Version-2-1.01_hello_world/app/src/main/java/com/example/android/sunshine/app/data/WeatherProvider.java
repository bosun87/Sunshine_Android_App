    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        switch (sUriMatcher.match(uri)) {
            ...
            case WEATHER: {
                ...
                qBuilder.setTables(WeatherContract.WeatherEntry.TABLE_NAME);

                retCursor = qBuilder.query(mOpenHelper.getReadableDatabase(),projection,selection,selectionArgs,null
                ,null,sortOrder);
                break;
            }
            // "location"
            case LOCATION: {
                ...
                qBuilder.setTables(WeatherContract.LocationEntry.TABLE_NAME);

                retCursor = qBuilder.query(mOpenHelper.getReadableDatabase(),projection,selection,selectionArgs,null,null,sortOrder);
                break;
            }
